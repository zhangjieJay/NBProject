<?php
    /*方法汇总
     * <a>先去开发者中心生成推送证书,本地打开后导出p12文件,默认为push.p12,
     * <b>终端输入(记得cd到push.p12文件的目录,apns-dev.pem使我们要获取到的文件) openssl pkcs12 -in push.p12 -out apns-dev.pem -nodes   这儿需要输入刚刚的密码
